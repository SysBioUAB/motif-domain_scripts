...
with open('outputs/domain-domain_observed_freq_prueba.txt','rt') as f_obs:
	for line in f_obs:
...
with open('outputs/domain-domain_random_freq_prueba.txt', 'rt') as f_rand:
	for line in f_rand:
		...
		if i in interactions_with_obs_freq:
			...
			if motif in motif_enrichment_only_enriched and domain in domain_enrichment_only_enriched:
				...
				if i in interactions_with_rand_freq and n >= 1:
					...
					with open('outputs/domain_domain_enrichment_nuevo_all.txt','at') as f:
